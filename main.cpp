...
int main()
{
    ...
    try
    {
        Persoana p1("Ionescu", "Ion", "20.03.1992"), p2("Popescu", "Vasile", "10.04.1993"), p3,p4("vasia", "Ion", "20.03.1996"),p5("I", "Io", "20.03.1995");
        cin>>p3;
        ...
        st[4] = new Student( p5, "01/AIA", "Automatica" );
        /*de continuat*/
        ...
        cout<<"\tProfesorul: "<<pers[4]->retNumeComplet()<<endl;
